/*
  # Flash Sale Configuration Table

  1. New Tables
    - `flash_sale_config`
      - `id` (uuid, primary key)
      - `sale_start_time` (timestamp with time zone)
      - `original_price` (numeric, default 999.00)
      - `price_stage_1_discount` (numeric, default 0.75 for 75% off)
      - `price_stage_2_discount` (numeric, default 0.50 for 50% off)
      - `price_stage_3_discount` (numeric, default 0.25 for 25% off)
      - `stage_1_duration_hours` (integer, default 12)
      - `stage_2_duration_hours` (integer, default 8)
      - `stage_3_duration_hours` (integer, default 4)
  ...
  3. Initial Data
    - Insert initial flash sale configuration with current timestamp
*/
